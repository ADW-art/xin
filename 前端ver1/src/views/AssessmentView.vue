...
.score-card { background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius-lg); box-shadow: var(--shadow-sm); padding: 20px 12px 16px; text-align: center; }
.sl { display: block; font-size: var(--font-xs); color: var(--text-secondary); margin-top: 6px; font-weight: 500; }

.card { background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius-lg); box-shadow: var(--shadow-sm); padding: 24px; margin-bottom: 18px; }
...
.bkt-bar-wrap { flex: 1; background: var(--bg-muted); border-radius: var(--radius-sm); height: 22px; overflow: hidden; }
.bkt-bar { height: 100%; border-radius: var(--radius-sm); color: #fff; font-size: 11px; font-weight: 600; text-align: right; padding-right: 6px; line-height: 22px; transition: width 0.8s ease; min-width: 30px; }
.bkt-bar.mastered { background: var(--primary-hover); }
.bkt-bar.learning { background: var(--primary); }
...
.bkt-level.mastered { color: var(--primary-hover); }
.bkt-level.learning { color: var(--primary); }
