  ...
  <div class="page">
    <div v-if="loading" class="profile-loading">
      <div class="profile-skeleton-header">
        ...
        <div class="sk-lines">
          <div class="sk-line shimmer" style="width: 120px; height: 20px;" />
          <div class="sk-line shimmer" style="width: 180px; height: 12px; margin-top: 8px;" />
        </div>
      </div>
      <div class="sk-line shimmer" style="width: 160px; height: 18px; margin: 28px 0 16px;" />
      <div class="sk-radar shimmer" />
      <div class="sk-line shimmer" style="width: 160px; height: 18px; margin: 28px 0 16px;" />
      <div class="sk-dim-grid">
        <div v-for="i in 6" :key="i" class="sk-dim-card shimmer" />
      </div>
    </div>
...
.profile-skeleton-header .sk-avatar {
  width: 64px;
  height: 64px;
  border-radius: 50%;
  flex-shrink: 0;
}
.profile-skeleton-header .sk-lines {
  display: flex;
