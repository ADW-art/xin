...
.rp-bar{flex:1;height:4px;background:var(--bg-muted);border-radius:var(--radius-sm);overflow:hidden}
.rp-fill{height:100%;background:var(--primary);border-radius:var(--radius-sm);transition:width .3s}
.rp-text{font-size:var(--font-xs);color:var(--text-muted);white-space:nowrap}
.rag-err{padding:8px 24px;font-size:var(--font-xs);color:var(--red);display:flex;align-items:center;gap:6px}
...
.rt-line{position:absolute;left:15px;top:28px;bottom:0;width:2px;background:var(--border)}
.rt-node.done .rt-line{background:var(--primary)}
.rt-node:last-child .rt-line{display:none}
.rt-dot{position:absolute;left:8px;top:10px;width:16px;height:16px;border-radius:50%;background:var(--border);display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700;color:#fff;transition:all .3s}
.rt-dot.on{width:22px;height:22px;left:5px;top:7px;font-size:12px}

.rt-card{margin-left:32px;background:var(--bg-card);border:1.5px solid var(--border);border-radius:var(--radius-lg);box-shadow:var(--shadow-sm);overflow:hidden;cursor:pointer;transition:all .2s}
.rt-card:hover{border-color:#93C5FD}
.rt-node.current .rt-card{border-color:var(--primary);box-shadow:var(--shadow-glow-blue)}
.rt-hd{display:flex;align-items:center;gap:8px;padding:10px 14px}
.rt-name{font-size:var(--font-sm);font-weight:600;flex:1}
.rt-badge{font-size:11px;padding:2px 10px;border-radius:999px;font-weight:600}
...
.rt-score-fill{height:4px;border-radius:var(--radius-sm);min-width:2px;flex:1}
...
.rte-bar-w{flex:1;height:5px;background:var(--bg-muted);border-radius:var(--radius-sm);overflow:hidden}
.rte-bar{height:100%;border-radius:var(--radius-sm);transition:width .6s}
...
.rr-chart{background:var(--bg-card);border:1px solid var(--border);border-radius:var(--radius-lg);box-shadow:var(--shadow-sm);padding:14px}
.rr-tt{font-size:var(--font-sm);font-weight:600;margin-bottom:6px}
.rr-hit{background:var(--bg-card);border:1px solid var(--border);border-radius:var(--radius-lg);box-shadow:var(--shadow-sm);padding:14px}
.rr-hit-grid{display:flex;gap:8px;margin-top:6px}
.rr-hit-card{flex:1;text-align:center;padding:10px 8px;border-radius:var(--radius-md);background:var(--bg-page)}
